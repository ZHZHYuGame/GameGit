...
namespace Quark.Loader
{
    ...
    internal abstract class QuarkAssetLoader
    {
        ...
        /// </summary>
        protected readonly Dictionary<string, QuarkBundleWarpper> bundleWarpperDict
            = new Dictionary<string, QuarkBundleWarpper>();
        /// <summary>
        /// AssetName===Lnk[QuarkObjectWapper]
        /// </summary>
        protected readonly Dictionary<string, LinkedList<QuarkObject>> objectLnkDict
            = new Dictionary<string, LinkedList<QuarkObject>>();
        /// <summary>
        /// AssetPath===QuarkObjectWapper
        /// </summary>
        protected readonly Dictionary<string, QuarkObjectWapper> objectWarpperDict
            = new Dictionary<string, QuarkObjectWapper>();
        /// <summary>
        /// 被加载的场景字典；
        /// SceneName===Scene
        /// </summary>
        protected readonly Dictionary<string, Scene> loadedSceneDict = new Dictionary<string, Scene>();
        /// <summary>
        /// 主动加载的场景列表；
        /// </summary>
